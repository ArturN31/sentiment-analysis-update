...
const SentimentOutput = ({ sentimentResponse }) => {
	...
	const sentimentStyles = new Map([
		...
		['slightly negative', { background: 'linear-gradient(45deg, #ffcc99, #ff9933)', color: '#000' }],
	...
	return sentimentResponse.sentiment ? (
		<div style={style} className='p-3 rounded d-grid align-self-center border border-dark border-5 shadow-sm'>
